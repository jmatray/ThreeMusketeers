...
10. [User Creation] User information will be saved in a JSON object as they are entering it in. Once the submit button is hit, this object will be pushed to firebase all at once - manual test (?) - sign up as a new user, press submit - check Firebase to see if user information is stored correctly
